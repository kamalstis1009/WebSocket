...
public class GroupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(v -> {
            ...
            stompClient.topic(ConstantKey.groupResponse.replace(ConstantKey.PLACEHOLDER, groupId)).subscribe(stompMessage -> {
        ...
        sendButton.setOnClickListener(v -> {
            ...
            stompClient.send(ConstantKey.group.replace(ConstantKey.PLACEHOLDER, groupId), jsonObject.toString()).subscribe();
            nameText.setText("");
        });
